...
public class NumberUtils {
    ...
    private static String getRoundStringValue(double numerical, int length) {
        ...
        if (length == 3) {
            decimalFlag = 1000;
            decimalFormat = new java.text.DecimalFormat("##,###,##0.000");
        } else if (length == 2) {
            decimalFlag = 100;
            decimalFormat = new java.text.DecimalFormat("##,###,##0.00");
        } else if (length == 1) {
            decimalFlag = 10;
            decimalFormat = new java.text.DecimalFormat("##,###,##0.0");
        } else if (length == 0) {
            decimalFlag = 0;
            decimalFormat = new java.text.DecimalFormat("##,###,###");
        } else {
            decimalFlag = 10000;
            decimalFormat = new java.text.DecimalFormat("##,###,##0.0000");
        }
        if (decimalFlag != 0) {
    ...
    private static double getRoundDoubleValue(double numerical, int length) {
        ...
        DecimalFormat decimalFormat = new java.text.DecimalFormat(formatStr.toString());
