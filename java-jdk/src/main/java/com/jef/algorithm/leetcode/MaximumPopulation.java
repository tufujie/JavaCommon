...
public class MaximumPopulation {
    ...
    public int maximumPopulation(int[][] logs) {
        ...
        for (Map.Entry<Integer, Integer> entry : map.entrySet()) {
            if (entry.getValue() > maxNum || (entry.getValue() == maxNum && entry.getKey() < maxYear)) {
