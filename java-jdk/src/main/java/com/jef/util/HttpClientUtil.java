...
public class HttpClientUtil {
    ...
    public static String sendPostRequest(String reqURL,
        ...
        try {
            ...
            log.info("与[" + reqURL + "]通信过程,请求参数如下: "+new JsonMapper().toJson(params));
            ...
            if (statusCode == 200) {
                ...
                log.error("与[" + reqURL + "]通信过程中发生异常,请求参数如下: "+new JsonMapper().toJson(params));
     ...
     * @return 远程主机响应正文
     */
    public static String sendPostRequest4Json(String reqURL, String jsonData, Map<String, String> head,
                                              boolean isEncoder, String encodeCharset, String decodeCharset)
            throws IOException {
        String responseContent = null;
        CloseableHttpClient httpClient = HttpClients.createDefault();
